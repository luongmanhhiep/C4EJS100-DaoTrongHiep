...
console.log('3.1:What is the data type of the outermost layer (Number, String, Object, Array or else)?');
console.log('Type of the outermost layer is: ' + typeof(data));
console.log(data);
console.log("\n");
console.log('3.2: The hits property is where the job results are stored, is it a Number, String, Array, Object or something else?');
console.log('Type of hits is Array: true' );
console.log(data);
console.log("\n");
console.log('3.3: In each hit of hits, how to find the job’s title, locations, salary, benefits, skills and requirements');
